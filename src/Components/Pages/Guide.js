                    ...
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>It all starts with a name. Make it memorable. Make it catchy.</p>
                            </div>
                        </div>
                    </div>
                    <div className='isguide'>
                    ...
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>Find the perfect design theme for your business. Choose something attractive.</p>
                            </div>
                        </div>
                    </div>
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>Managing orders just got simpler thanks to our order management tool</p>
                            </div>
                        </div>
                    </div>
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>You have the product. You have the store. Add your products, set the price and get ready to sell.</p>
                            </div>
                        </div>
                    </div>
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>MyShop gives you the data you need to better understand your sales.</p>
                            </div>
                        </div>
                    </div>
                    <div className='isguide'>
                        ...
                        <div className='sGuide'>
                            ...
                            <div className='guideText'>
                                ...
                                <p>It all starts with a name. Make it memorable. Make it catchy. This is the brand you’ll be branding.</p>
                            </div>
                        </div>
                    </div>
                </div>
